...
% {\color{darkgray}{\center{ \small{      ``There is no template, no stock of proven answers to the questions, `Which aspects of this practice can and should be made sustainable?' or `Is this practice so important, at present, that we can justify continuing it even though people in the future will therefore be forced to find a substitute or do without?'''
% \\%[3pt]
% \rightline{{\rm --- Kelly A. Parker \cite{Bartels2012-le}}}}}}}
